...
# Title: Four Channel PRB Sequence
# Generated: Thu Jan 14 14:21:42 2016
##################################################
...
class PRBS_Four_Channel(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Four Channel PRB Sequence")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Four Channel PRB Sequence")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "PRBS_Four_Channel")
        ...
        self.my_amp4 = my_amp4 = 0.5
        self.my_amp3 = my_amp3 = 0.5
        ...
        # Blocks
        ##################################################
        self._samp_rate_options = (750000, 1500000, 3000000, 6000000, 12000000, )
        self._samp_rate_labels = ("750K", "1.5M", "3M", "6M", "12M", )
        ...
        self._my_amp4_range = Range(0, 1, 0.05, 0.5, 200)
        self._my_amp4_win = RangeWidget(self._my_amp4_range, self.set_my_amp4, "Amplitude 4", "counter_slider", float)
        self.top_layout.addWidget(self._my_amp4_win)
        self._my_amp3_range = Range(0, 1, 0.05, 0.5, 200)
        self._my_amp3_win = RangeWidget(self._my_amp3_range, self.set_my_amp3, "Amplitude 3", "counter_slider", float)
        self.top_layout.addWidget(self._my_amp3_win)
        ...
        self._my_rate_options = (100000, 500000, 1000000, 2000000, 3000000, )
        self._my_rate_labels = ("100K", "500K", "1M", "2M", "3M", )
        ...
        self.blocks_repeat_0_1_0 = blocks.repeat(gr.sizeof_int*1, interp)
        self.blocks_repeat_0_1 = blocks.repeat(gr.sizeof_int*1, interp)
        self.blocks_repeat_0_0 = blocks.repeat(gr.sizeof_float*1, interp)
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_int*1, interp)
        self.blocks_int_to_float_0_0_0 = blocks.int_to_float(1, 1/my_amp4)
        self.blocks_int_to_float_0_0 = blocks.int_to_float(1, 1/my_amp3)
        self.blocks_int_to_float_0 = blocks.int_to_float(1, 1/my_amp2)
        self.blocks_float_to_complex_0_0 = blocks.float_to_complex(1)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.analog_random_source_x_0_0_0 = blocks.vector_source_i(map(int, numpy.random.randint(0, 2, 1000)), True)
        self.analog_random_source_x_0_0 = blocks.vector_source_i(map(int, numpy.random.randint(0, 2, 1000)), True)
        ...
        self.connect((self.analog_random_source_x_0_0, 0), (self.blocks_repeat_0_1, 0))    
        self.connect((self.analog_random_source_x_0_0_0, 0), (self.blocks_repeat_0_1_0, 0))    
        self.connect((self.blocks_float_to_complex_0, 0), (self.uhd_usrp_sink_0, 0))    
        self.connect((self.blocks_float_to_complex_0_0, 0), (self.uhd_usrp_sink_0, 1))    
        self.connect((self.blocks_int_to_float_0, 0), (self.blocks_float_to_complex_0, 1))    
        self.connect((self.blocks_int_to_float_0_0, 0), (self.blocks_float_to_complex_0_0, 0))    
        self.connect((self.blocks_int_to_float_0_0_0, 0), (self.blocks_float_to_complex_0_0, 1))    
        ...
        self.connect((self.blocks_repeat_0_1, 0), (self.blocks_int_to_float_0_0, 0))    
        self.connect((self.blocks_repeat_0_1_0, 0), (self.blocks_int_to_float_0_0_0, 0))    
    ...
    def get_my_amp4(self):
        return self.my_amp4

    def set_my_amp4(self, my_amp4):
        self.my_amp4 = my_amp4
        self.blocks_int_to_float_0_0_0.set_scale(1/self.my_amp4)

    def get_my_amp3(self):
        return self.my_amp3

    def set_my_amp3(self, my_amp3):
        self.my_amp3 = my_amp3
        self.blocks_int_to_float_0_0.set_scale(1/self.my_amp3)
    ...
    def set_interp(self, interp):
        ...
        self.blocks_repeat_0_1_0.set_interpolation(self.interp)
        self.blocks_repeat_0_1.set_interpolation(self.interp)


def main(top_block_cls=PRBS_Four_Channel, options=None):
